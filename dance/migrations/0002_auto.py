...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field performances on 'Group'
        db.create_table('dance_group_performances', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm['dance.group'], null=False)),
            ('performance', models.ForeignKey(orm['dance.performance'], null=False))
        ))
        db.create_unique('dance_group_performances', ['group_id', 'performance_id'])


    def backwards(self, orm):
        # Removing M2M table for field performances on 'Group'
        db.delete_table('dance_group_performances')
    ...
    models = {
        ...
        'dance.group': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'performances': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['dance.Performance']", 'symmetrical': 'False'}),
