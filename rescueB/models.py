...
class Performance(models.Model):
    ...
    kit_deploy = models.IntegerField(default=0)
    lack_of_progress = models.IntegerField(default=0)
    bump = models.IntegerField(default=0)
    ramp_up = models.IntegerField(default=0)
    ramp_down = models.IntegerField(default=0)
...
class MatchSaveForm(forms.Form):
    ...
    kit_deploy = forms.IntegerField(label='Kit deploy')
    lack_of_progress = forms.IntegerField(label='Lack of Progress')
    bump = forms.IntegerField(label='Bump')
    ramp_up = forms.IntegerField(label='Ramp Up')
    ramp_down = forms.IntegerField(label='Ramp Down')
    checkpoints = forms.IntegerField(label='Checkpoints')
