...
# usually for local usage
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.path.join(DIR, 'scoreboard.db'), # Or path to database file if using sqlite3.
...
SITE_ID = 1
SITE_NAME = "RoboCupJunior Slovak Open 2015"
...
MEDIA_ROOT = os.path.join(DIR, 'tmp')
...
STATIC_ROOT = os.path.join(DIR, 'staticed/')
...
STATICFILES_DIRS = (
    ...
    os.path.abspath(os.path.join(DIR, '../scorebrd/static/')),
)
