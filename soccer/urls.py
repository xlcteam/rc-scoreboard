...
urlpatterns = patterns('soccer.views',
    ...
    url(r'^group/generate/schedule/(?P<group_id>\d+)\.pdf/?$',
        'schedule_generate', name="schedule_generate"),
    url(r'^group/addteam/(?P<group_id>\d+)/?$', 'add_team', name='add_team'),
    ...
    url(r'^results/livefeed/?$', 'results_live_feed',
        name="results_live_feed"),
    ...
    url(r'^results/group/(?P<group_id>\d+)/recompute/?$',
        'recompute_group_table', name="recompute_group_table"),
    url(r'^results/group/(?P<group_id>\d+)\.pdf/?$', 'results_group_pdf',
        name="results_group_pdf"),
    url(r'^results/competition/(?P<competition_id>\d+)\.pdf/?$',
        'results_competition_pdf', name="results_competition_pdf"),
    ...
    url(r'^results/livegroup/json/(?P<group_id>\d+)/?$',
        'group_live_json_result'),
)
